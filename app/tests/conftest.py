...
def add_win_entry():
    ...
    def _add_win_entry(title, user):
        win_entry = WinEntry.objects.create(user=user, title=title)
        return win_entry
...
def add_ideas_entry():
    ...
    def _add_ideas_entry(content, user):
        ideas_entry = IdeasEntry.objects.create(user=user, content=content)
        return ideas_entry
...
def add_emotion_entry():
    ...
    def _add_emotion_entry(emotion, user):
        emotion_entry = EmotionEntry.objects.create(user=user, emotion=emotion)
