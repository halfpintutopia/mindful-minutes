...
def test_add_ideas_entry_not_current_date(authenticated_user, date_param):
    """
    GIVEN a Django application
...
@pytest.mark.django_db
def test_get_single_ideas_entry(authenticated_user, add_ideas_entry):
    """
    GIVEN a Django application
...
def test_get_all_ideas_entries_by_current_date(
    ...
    ideas_entries = IdeasEntry.objects.filter(created_on__date=current_date)
    assert len(ideas_entries) == 1
...
def test_get_all_ideas_entries_by_date(
    authenticated_user, add_ideas_entry, created_on_timestamp
):
    """
    GIVEN a Django application
...
@pytest.mark.django_db
def test_remove_ideas_entry(authenticated_user, add_ideas_entry):
    """
    GIVEN a Django application
...
@pytest.mark.django_db
def test_remove_ideas_invalid_id(authenticated_user):
    """
    GIVEN a Django application
...
def test_update_ideas_entry(authenticated_user, add_ideas_entry, test_data):
    """
    GIVEN a Django application
...
def test_update_ideas_entry_invalid_json(
    authenticated_user, add_ideas_entry, test_data
):
    """
    GIVEN a Django application
