...
def test_add_win_entry_not_current_date(authenticated_user, date_param):
    """
    GIVEN a Django application
...
@pytest.mark.django_db
def test_get_single_win_entry(authenticated_user, add_win_entry):
    """
    GIVEN a Django application
...
def test_get_all_win_entries_by_current_date(authenticated_user, add_win_entry):
    ...
    win_entries = WinEntry.objects.filter(created_on__date=current_date)
...
def test_get_all_win_entries_by_date(
    authenticated_user, add_win_entry, created_on_timestamp
):
    """
    GIVEN a Django application
    ...
    win_entries = WinEntry.objects.filter(created_on__date=date_and_time[0])
    assert len(win_entries) == 4


@pytest.mark.django_db
def test_remove_win_entry(authenticated_user, add_win_entry):
    """
    GIVEN a Django application
...
@pytest.mark.django_db
def test_remove_win_invalid_id(authenticated_user):
    """
    GIVEN a Django application
...
def test_update_win_entry(authenticated_user, add_win_entry, test_data):
    """
    GIVEN a Django application
...
@pytest.mark.django_db
def test_update_win_entry_incorrect_data(authenticated_user, add_win_entry):
    """
    GIVEN a Django application
