...
class NoteEntryList(APIView):
    ...
    def get(self, request, date_request, format=None):
        ...
        """
        return self._handle_note_list_action(request, date_request)
    ...
    def _handle_note_list_action(self, request, date_request):
        """
        ...
        if request.method == "POST":
            ...
            if date_request != current_date:
                return Response(
                    {
                        "error":
                        "You are not allowed to change notes \
...
class NoteEntryDetail(APIView):
    ...
    def get(self, request, date_request, pk, format=None):
        ...
        """
        return self._handle_note_detail_action(request, date_request, pk)
    ...
    def _handle_note_detail_action(self, request, date_request, pk):
        """
